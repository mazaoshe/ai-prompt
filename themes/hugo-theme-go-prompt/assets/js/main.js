...
document.addEventListener('DOMContentLoaded', function () {
    ...
    codeBlocks.forEach(block => {
        ...
        copyButton.className = 'copy-code-button absolute top-1.5 right-1.5 w-6 h-6 flex items-center justify-center rounded bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 opacity-0 transition-opacity duration-200 cursor-pointer';
        copyButton.innerHTML = `
      <svg xmlns="http://www.w3.org/2000/svg" class="copy-icon w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
      </svg>
      <svg xmlns="http://www.w3.org/2000/svg" class="copied-icon w-3 h-3 hidden text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
